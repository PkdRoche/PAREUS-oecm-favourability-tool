                ...
                try:
                    ...
                    if _pa_gdf_ie_map is not None and len(_pa_gdf_ie_map) > 0:
                        try:
                            ...
                            _iucn_col_ie = ('IUCN_MAX' if 'IUCN_MAX' in _pa_gdf_ie_map.columns
                                            else 'IUCN_CAT')
                            _keep_ie = [c for c in ['WDPA_NAME', 'protection_class',
                                                     _iucn_col_ie, 'geometry']
                                        if c in _pa_gdf_ie_map.columns]
                            _pa_slim_ie = _pa_gdf_ie_map[_keep_ie].copy()
                            _pa_slim_ie['geometry'] = _pa_slim_ie.geometry.simplify(
                                100, preserve_topology=True
                            )
                            ...
                            _colours_ie = dict(_ov_col_ie)
                            folium.GeoJson(
                                _pa_slim_ie,
                                name='PA Network',
                                style_function=lambda feat, _c=_colours_ie: {
                                    'fillColor': _c.get(
                                        feat['properties'].get('protection_class', ''),
                                        '#9E9E9E'
                                    ),
